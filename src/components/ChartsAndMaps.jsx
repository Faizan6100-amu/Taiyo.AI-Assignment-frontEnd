...
useEffect(() => {
  ...
  return (
    <div>
        <Heading color={'white'} p={"10px 20px"} m={"0px"} bg={"rgb(136 19 55)"}>Charts and Maps</Heading>
        <div id="charts_page_div">
        {window.innerWidth>900?<Box padding={"10px"} w={"19%"} boxShadow={"rgba(0, 0, 0, 0.24) 0px 3px 8px"} bg={"rgb(226 232 240)"}>
            ...
            <Box padding={"30px"} margin={'auto'}  w={"79%"} boxShadow={"rgba(0, 0, 0, 0.24) 0px 3px 8px"} border={"1px solid gray"} bg={"rgb(241 245 249)"}>
